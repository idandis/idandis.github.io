...
.entypo-light-bulb:before {
  ...
  .dark-mode {
   ...
   <div class="break-out" style="background-color:#343541; text-align:right">
     <div style="padding-left:40px">
     <span id="moonsun" onclick="myFunction()"><i style="font-size:24px; color:white; cursor:pointer" class="fa">&#xf042; &nbsp;&nbsp;&nbsp;</i></span>
    </div>
   </div>
	...
	<div class="container" id="resume">
			<div id="card" class="row">
				<div class="col-xs-3 col-sm-4">
					<img class="avatar" src="https://www.easy2web.it/foto.jpg"/>
				</div>
				<div class="col-xs-9 col-sm-8">
					<h1>Iana Longo Dandis</h1>
					<h2> computer engineering student - Università degli Studi di Bergamo</h2>
					<section id="basics">
						<div class="contact">
							<div class="website">
								<icon class="entypo-compass"></icon>
								<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/">https://github.com/idandis/</a>
							</div>
							<div class="email">
								<icon class="entypo-mail"></icon>
								<a style="color:#fcba80" target="_blank" class="" href="#">ianadandis98@gmail.com</a>
							</div>
						</div>
						<section id="location">
						</section>
						<section id="profiles">
							<div class="item">
								<a style="color:#fcba80" target="_blank" href="https://github.com/idandis">
			...
			<div id="summary" class="row">
				<div class="col-sm-8 col-sm-offset-4 col-xs-12">
					<div class="summary">
						<p class="lead">"I am a computer engineering student who is passionate about improving my technical skills. In my free time, I take various courses on Udemy to expand my knowledge. Along with my studies, I have also been working as a full-stack web developer at Cliccasa.it, gaining valuable experience in the field. I am excited to continue growing and learning in the world of computer engineering"</p>
					</div>
				</div>
			</div>
            <br>
	<section id="work" class="row">
		...
		<div class="col-sm-8">
			<div class="item">
				...
				<div class="position">
					<p class="lead">Science Popularizer</p>
				</div>
				<div class="date">
				...
				<div class="summary">
					<p>I acted as a guide for exhibitions and labs at Bergamo Scienza, including math and physics labs</p>
				</div>
			...
			<div class="item">
				...
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://www.cliccasa.it/">https://www.cliccasa.it/</a><br>
                    <a style="color:#fcba80" target="_blank" href="https://www.capannonionline.it/">https://www.capannonionline.it/</a>
				</div>
				<div class="summary">
					<p>Clicgroup s.r.l. is an innovative start-up operating in the real estate sector. It specializes in the development of a real estate portal that allows the publication of properties through collaborations with agencies or individuals throughout Italy, offering various innovative services that facilitate the buying and selling or renting of properties.</p>
				</div>
				<ul class="highlights">
					<li>Programming in Python, &nbsp;Javascript, &nbsp; PHP,&nbsp; HTML,&nbsp; CSS</li>
					<li>Database technologies for Web development (SQL)</li>
				</ul>
			</div>
		</div>
	</section>
<br>
	...
	<section id="education" class="row">
		...
		<div class="col-sm-8">
			<div class="item">
				<h3 class="institution">Università degli Studi di Bergamo</h3>
				<div class="area">
					<p class="lead">Computer Engineering and Applied Sciences</p>
				</div>
			...
			<div class="item">
				<h3 class="institution">I.S.I.S Luigi Einaudi</h3>
				<div class="area">
					<p class="lead">Scientific high school, applied sciences option</p>
				</div>
	...
	<section id="project" class="row">
		...
		<div class="col-sm-8">
			<div class="item">
				<h3 class="name">Statistics and stochastic models for dataset analysis</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/statistics-and-stochastic-models">https://github.com/idandis/statistics-and-stochastic-models</a>
				</div>
				<div class="summary">
					<p>Analysis on a dataset contains daily data on pollutants and meteorological variables from the Arpa Lombardia website, specifically from the Milano Città Studi Pascal monitoring station, and also data on car travel in Milan based on road directions from Cupertino maps. The goal of the analysis was to identify any relationships between ozone presence in the area and other factors using only descriptive statistics (multiple regression, some advanced regression techniques, and nonparametric techniques) with Matlab.</p>
				</div>
                
			</div>
			<div class="item">
				<h3 class="name">Statistics and stochastic models for analyzing statistical data and make predictions</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/statistics-and-stochastic-models">https://github.com/idandis/statistics-and-stochastic-models</a>
				</div>
				<div class="summary">
					<p>The project is about analyzing statistical data from the Arpa Lombardia website, which contained a daily collection of atmospheric pollutant quantities and related meteorological variables. Using statistical methods and MATLAB, the goal was to train the predictive capability of the created model using statistical analysis tools and algorithm.</p>
				</div>
			</div>
            
			<div class="item">
				<h3 class="name">Orienteering live results with a cross platform mobile app</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/flutter_orienteering">https://github.com/idandis/flutter_orienteering</a>
				</div>
				<div class="summary">
					<p>The project consist in a developed of a distributed system using cloud and mobile technologies, specifically using AWS services (S3 bucket, DynamoDB, JavaScript and Python Lambda functions, and API Gateway) to create a Flutter application using Dart for managing and live consulting the results of an orienteering race.</p>
				</div>
			</div>
			<div class="item">
				<h3 class="name">Dynamic web page that calculate the consumption of methane</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" target="_blank" href="https://www.quantospendodimetano.it">https://www.quantospendodimetano.it</a>
				</div>
				<div class="summary">
					<p>Collaboration in the creation of a dynamic web page that allows to calculate approximately the consumption of methane necessary to heat one's home in the colder months, by inserting the energy performance index, the cost of methane, and the square meters of the home.</p>
				</div>
			</div>
			<div class="item">
				<h3 class="name">Java OOP for a video games scheduler</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/dandis_iana_info2">https://github.com/idandis/dandis_iana_info2</a>
				</div>
				<div class="summary">
					<p> An application in Java that manages a set of video game challenges. The application is able to read information from an external text file and manage different schedules for scheduling challenges for competitors, with the ability to add or remove users or new challenges, and manage possible system errors.</p>
				</div>
			</div>
			<div class="item">
				<h3 class="name">Java synchronization methods for a computer laboratory</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/synchronous_programming_java">https://github.com/idandis/synchronous_programming_java</a>
				</div>
				<div class="summary">
					<p> In this project i using java direct or indirect synchronization methods to manage a computer laboratory. In particular, the laboratory is open to an unlimited number of students and has a limited number of workstations. Each student can exclusively use one or two workstations for a limited amount of time. If the workstations are not available, the student must wait. Based on their needs (one or two workstations), students are classified into two different waiting queues, and each queue has different priorities to respect</p>
				</div>
			</div>
			<div class="item">
				<h3 class="name">Speed detection using PCSPIM</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://github.com/idandis/assembly_project_work">https://github.com/idandis/assembly_project_work</a>
				</div>
				<div class="summary">
					<p>The project consist in a program in assembly language using PCSPIM, a MIPS processor simulator, for a speed detection system based on the MIPS R2000 processor (clock speed of 250 MHz). The system utilizes two sensors placed one meter apart that can detect the presence of a vehicle. The program is designed to detect when a vehicle is traveling faster than the 90 km/h speed limit on an rural road. When this occurs, after one second has passed, the program commands the shutter of a camera to take a picture with a 500 ms pulse, and then resumes monitoring for the next vehicle, and so on.</p>
				</div>
			</div>
...
<br>
	<section id="courses" class="row">
		...
		<div class="col-sm-8">
			<div class="item">
				<h3 class="name">The Complete JavaScript Course 2022: From Zero to Expert!
                </h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://www.udemy.com/certificate/UC-3b6ca4dd-d969-4d19-9698-399c052e2f50/">https://www.udemy.com/certificate/UC-3b6ca4dd-d969-4d19-9698-399c052e2f50/</a>
				</div>
				<div class="summary">
					<p>During this course, I developed 6 applications and completed over 50 challenges</p>
				</div>
			</div>
		

			<div class="item">
				<h3 class="name">SEO Masterclass - Dominate The Search Results</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://www.udemy.com/certificate/UC-ebadbc64-2e75-4687-a084-cb1f49e274f0/">https://www.udemy.com/certificate/UC-ebadbc64-2e75-4687-a084-cb1f49e274f0/</a>
				</div>
				<div class="summary">
					<p>During this course, i learn the most important aspects of how rank a website in search engines and olso acquire how to optimize every aspect of a website to maximise the chances of earning a high                       ranking in search results</p>
				</div>
			</div>

            <div class="item">
				<h3 class="name">The Linux Command Line Bootcamp: Beginner To Power User</h3>
				<div class="website">
					<a style="color:#fcba80" target="_blank" href="https://www.udemy.com/certificate/UC-ebadbc64-2e75-4687-a084-cb1f49e274f0/">https://www.udemy.com/certificate/UC-ebadbc64-2e75-4687-a084-cb1f49e274f0/</a>
				</div>
				<div class="summary">
					<p>During this course, i level up my command line skills and also gained new knowledge abount Linux/Ubuntu system</p>
				</div>
			</div>
		</div>
	</section>
...
<!--
	<section id="publications" class="row">
		...
		<div class="col-sm-8">
			...
			<div class="item">
				<div class="name">
					<h3>Artifact: Scalable Distributed Data Anonymization</h3>
				</div>
				<div class="publisher">
					<p class="lead"></p>
				</div>
...
-->
	<section id="skills" class="row">
		...
		<div class="col-sm-6">
			<div class="item">
				...
				<ul class="keywords">
					<li>Python,&nbsp; Java,&nbsp; Javascript,&nbsp; PHP,&nbsp; C++,&nbsp; HTML,&nbsp; CSS</li>
				</ul>
			</div>
            ...
            <div class="item">
				<h3 class="name">Other technologies used occasionally</h3>
				<ul class="keywords">
					<li>AWS (apigateway, lamda, bucket S3)</li>
                    <li>Flutter & Dart</li>
				</ul>
			</div>
	...
	<section id="languages" class="row">
		...
		<div class="col-sm-8">
            ...
            <div class="item">
				<h3 class="language">Russian</h3>
				<div class="fluency">
					<em>Native speaker</em>
				</div>
			</div>
            <div class="item">
				<h3 class="language">Romanian</h3>
				<div class="fluency">
					<em>Native speaker</em>
				</div>
			</div>
	...
	<section id="interests" class="row">
		...
		<div class="col-sm-8">
			<div class="item">
				<h3><span class="label label-default label-lg">Technology</span></h3>
			</div>
			<div class="item">
				<h3><span class="label label-default label-lg">Nature</span></h3>
			</div>
			<div class="item">
				<h3><span class="label label-default label-lg">Travel</span></h3>
			</div>
			<div class="item">
				<h3><span class="label label-default label-lg">Outdoor Sports</span></h3>
			</div>
		</div>
	</section>
